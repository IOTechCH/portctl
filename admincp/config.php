									...
									if(isset($_GET['do']))
									{
										...
										if($do=="edit")
										{
											...
											if(isset($_POST['submit']))
											{
												...
												$issues = $_POST['issues'];
												$base = $_POST['base'];
												echo "Site configuration must be updated manually in getconfig.php file.";
											}
											else
											{
												...
												?>
													<form method="POST">
														Site Name: <input type="text" name="sitename" value="<?php echo $sitename; ?>"><br>
														Admin Email: <input type="text" name="adminemail" value="<?php echo $adminemail; ?>"><br>
														Dashboard Message: <input type="text" name="adminmsg" value="<?php echo $adminmsg; ?>"><br>
														Network Issue Count: <input type="text" name="issues" value="<?php echo $netissuecount; ?>"><br>
														Website URL(baseurl): <input type="text" name="base" value="<?php echo $baseurl; ?>"><br>
														<br><input type="hidden" name="csrf_token" value="<?php echo $_SERVER['REMOTE_ADDR']; ?>">
														<input type="submit" name="submit" value="Update Configuration" class="btn btn-primary">
													</form>
												<?php
											}
										}
