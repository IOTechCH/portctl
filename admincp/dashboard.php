												...
												<div class="widget-summary-col">
													<div class="summary">
														...
														<div class="info">
															<?php
																$support_info = array();
																$sup_total = $db->prepare('SELECT * FROM `support_tickets`'); $sup_total->execute(array());
																$support_info['amount']=$sup_total->rowCount();
																$sup_unread = $db->prepare('SELECT * FROM `support_tickets` WHERE `status` = "0"');
																$sup_unread->execute(array());
																$support_info['unread'] = $sup_unread->rowCount();
															?>
															<strong class="amount"><?php echo $support_info['amount']; ?></strong>
															<span class="text-primary">(<?php echo $support_info['unread']; ?> unread)</span>
														</div>
													</div>
													<div class="summary-footer">
														<a href="support.php" class="text-muted text-uppercase">View</a>
													</div>
												</div>
											</div>
										</div>
									...
									<section class="panel panel-featured-left panel-featured-secondary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Total Pending Orders</h4>
														<div class="info">
															<?php
																$order_counter = $db->prepare('SELECT * FROM `orders` WHERE `order_status` = "0"');
																$order_counter->execute(array());
															?>
															<strong class="amount"><?php echo $order_counter->rowCount(); ?></strong>
														</div>
													</div>
													<div class="summary-footer">
														<a href="pending.php" class="text-muted text-uppercase">View</a>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														...
														<div class="info">
															<strong class="amount"><?php echo date('m/d/Y h:i:s a', time()); ?></strong>
														</div>
													</div>
													<div class="summary-footer">
									...
									<section class="panel panel-featured-left panel-featured-quartenary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Total Network Issues</h4>
														<div class="info">
															<strong class="amount"><?php echo $netissuecount; ?></strong>
														</div>
													</div>
													<div class="summary-footer">
														<a class="text-muted text-uppercase"></a>
