				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-8">
							...
							<h2 class="shorter">A Team <strong>United</strong></h2>
							<h4></h4>
							<p>With combined experience of over 10 years, and a variety of skill sets, we provide top-notch services with affordable costs.</p>

							<ul class="list icons list-unstyled">
								<li><i class="fa fa-check"></i> 10+ years experience</li>
								<li><i class="fa fa-check"></i> Affordable services</li>
								<li><i class="fa fa-check"></i> Wide skill-set</li>
							</ul>
