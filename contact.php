			...
			<div role="main" class="main">
				...
				<div class="container">
					...
					<div class="row">
							...
							<h2 class="shorter">Multiple ways to <strong>reach us</strong></h2>
							<p>
								You can contact us via 
								<a href="mailto:<?php echo $adminemail; ?>"><font color="#000;">email</font></a>.<br>
								If you are a registered customer with us <a href="clients/support.php">you can open a support ticket here.</a>
							</p>
					</div>
				</div>
			</div>
